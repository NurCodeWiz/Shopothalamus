...
def seed_product_orders():
        ...
        product_order5=ProductOrder(product_id=1, order_id=3, quantity=2)
        product_order6=ProductOrder(product_id=2, order_id=3, quantity=1)
        product_order7=ProductOrder(product_id=3, order_id=3, quantity=1)
        product_order8=ProductOrder(product_id=4, order_id=3, quantity=1)



        all_product_orders = [product_order1, product_order2, product_order3,product_order4,product_order5,product_order6,product_order7,product_order8]

...
def seed_product_orders():
        ...
        all_product_orders = [product_order1, product_order2, product_order3,product_order4,product_order5,product_order6,product_order7,product_order8,product_order9]
